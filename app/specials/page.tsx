      ...
      <div className="mx-auto max-w-[920px] text-center">
        ...
        <div className="mx-auto mt-5 max-w-[640px] overflow-hidden rounded-xl bg-[#f8f7ef] text-left shadow-[0_12px_32px_rgba(45,45,35,0.10)]">
          <div className="relative overflow-hidden px-7 pb-6 pt-7 md:min-h-[530px] md:px-9 md:pt-8">
            ...
            <div className="absolute -right-16 top-0 hidden h-[calc(100%-74px)] w-[48%] overflow-hidden rounded-bl-[55%] bg-[#dfe4d6] md:block">
              <img src="/images/specials-friends.jpg" alt="Two friends enjoying a skincare treatment together" className="absolute inset-0 h-full w-full scale-[1.55] object-cover object-[50%_86%]" />
