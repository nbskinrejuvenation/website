...
const VERCEL_FROM_PRICES: Record<string, number> = {
  ...
  // $60 is the add-on peel, not a session — cheapest real session is stretch marks at $190
  'microneedling': 190,
  'micro-needling': 190,
  'radio-frequency': 90,
  'tattoo-removal': 50,
...
export default async function ServicesPage() {
  ...
  return (
    ...
    <div className="section-container py-16">
      ...
      {body.length > 0 && (
        <section id="body" className="mb-16 scroll-mt-24">
          <h2 className="mb-8 text-xl font-semibold uppercase tracking-widest text-brand-500">
            Body
          </h2>
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
      ...
      {face.length === 0 && body.length === 0 && laser.length === 0 && (
