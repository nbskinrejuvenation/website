...
Replace placeholders by setting `hero_image` in Supabase or passing `heroImageUrl` to components.
...
Generate 4 variants with subjects: serum and towel on marble; gentle facial hands; elegant device in clinic; hydrodermabrasion mist.
